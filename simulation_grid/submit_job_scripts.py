...
export CHOLLA_HOME=/gpfs/alpine/ast175/scratch/bvilasen/cosmo_sims/cholla_execs
export WORK_DIR={sim_directory}
cd {sim_directory}

date
export OMP_NUM_THREADS=7
jsrun --smpiargs="-gpu" -n{n_mpi_tasks} -a1 -c7 -g1 --bind packed:7 $CHOLLA_HOME/cholla.cosmo.full_output $WORK_DIR/param.txt > $WORK_DIR/simulation_output.log |sort
"""
  if save_file:  
