...
if grid_name.find('zreion5p4') > 0: deltaZ_H = -0.82
...
constant_UVB_parameters = { 'deltaZ_H':deltaZ_H } 
SG.Create_UVB_Rates_Files( input_file_name=grackle_UVB_file_name, constant_parameters=constant_UVB_parameters, extend_rates_z=False  )
