...
fit_name += f'_RT_corrected'
fit_name += f'sigma_factor_{sigma_factor}'
...
custom_ps_data = { 'root_dir': root_dir + 'flux_power_spectrum_RT_corrected', 'file_base_name':'flux_ps_sampled_boera_extended', 'stats_base_name':None }
