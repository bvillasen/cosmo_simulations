...
rates_data_all = {}
for sim_id, delta_z_val in enumerate(delta_z_vals):
  ...
  parameter_values = { 'deltaZ_H':delta_z_val }
...
Plot_UVB_Rates( base_dir, rates_data=rates_data_all, figure_name='UVB_rates_all.png' )
