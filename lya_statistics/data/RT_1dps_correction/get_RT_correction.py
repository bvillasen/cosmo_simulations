...
def get_RT_1Dpk_correction( current_z, zR, print_out = True ): 

	#Check user parameter range
	if zR < 5.3 or zR >  6.7:	print("WARNING: Extrapolating outside of zR range")
	...
	z_mid = current_z - 0.390 * zR + 2.31
	if print_out: f'z_mid: {z_mid}'

	Ru = f( z_mid, Y )
	correction = Ru.flatten()
	return Y, correction
