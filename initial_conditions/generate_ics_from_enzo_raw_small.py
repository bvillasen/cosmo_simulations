...
input_dir  = data_dir + f'cosmo_sims/ics/{n_points}_{L_Mpc}Mpc/ics_raw/'
...
if ics_particles:
  ...
  data_ics['dm']['p_mass'] = file_attrs['dm_particle_mass'] / h
  data_ics['dm']['pos_x'] = p_pos_x / h
  data_ics['dm']['pos_y'] = p_pos_y / h
  data_ics['dm']['pos_z'] = p_pos_z / h
