...
from system_job_scripts import create_job_script_summit

root_dir =  data_dir + 'scaling/summit_large_noMPIReduce/'
params_dir = root_dir + 'param_files/'
create_directory( root_dir )
create_directory( params_dir )

tile_size = 128
tile_length = 25000.0 #kpc/h
work_dir = '/gpfs/alpine/csc380/proj-shared/cholla/scaling/summit_large_noMPIReduce/'
...
n_procs_list = [ 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384  ]
time = '01:00'

n_sims = len( n_procs_list)
n_nodes = int( ( max(n_procs_list) - 1 ) / 6 ) + 1 

job_params = {}
job_params['project'] = 'AST175'
...
job_params['bin_name'] = 'cholla.cosmology.summit'
job_params['partition'] = 'debug'


job_file_name = root_dir + 'submit_job_summit.lsf'
job_script = create_job_script_summit( job_params, file_name=job_file_name  )
