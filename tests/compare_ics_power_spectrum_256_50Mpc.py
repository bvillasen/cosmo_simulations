...
sim_dir = data_dir + 'cosmo_sims/cholla_ics/256_50Mpc/'
input_dir_0 = sim_dir + 'snapshot_files_ics_music/'
input_dir_1 = sim_dir + 'snapshot_files_ics_cholla/'
input_dirs = [ input_dir_0, input_dir_1 ]

output_dir = data_dir + 'cosmo_sims/cholla_ics/figures/'
...
figure_name  = output_dir + f'power_spectrum_comparison_256_50Mpc.png'
