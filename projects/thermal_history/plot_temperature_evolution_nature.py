...
time_axis = None
Plot_T0_evolution( output_dir, data_sets=data_to_plot, system='Shamrock', label='', fig_name='fig_T0_evolution_nature_V22', black_background=False, 
                   plot_interval=True, interpolate_lines=True, n_samples_interp=200, time_axis=time_axis, annotate_heating_epochs=True)
