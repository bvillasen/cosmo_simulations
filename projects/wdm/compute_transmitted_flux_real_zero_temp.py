...
output_dir = sim_dir + 'transmitted_flux_temp_10/'
# output_dir = sim_dir + 'transmitted_flux_unchanged/'
...
for space in [ 'real', 'redshift']:
  ...
  skewers_data['temperature'] = np.ones_like( skewers_data['temperature'] * 10 )
