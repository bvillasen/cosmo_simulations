...
oslo = palettable.scientific.sequential.Oslo_20
...
Plot_Corner( samples_all['param'], data_labels, corner_labels, output_dir, n_bins_1D=20, n_bins_2D=35, 
             ...
             limits=limits, param_values=param_values, black_background=True, figure_name='corner_wdm_black.png', 
             param_names=p_names, param_labels=param_labels, cmap=oslo, line_color_index=12, line_color=light_blue  )
