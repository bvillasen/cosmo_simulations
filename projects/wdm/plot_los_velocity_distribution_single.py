...
for snap_id in range(3):
  ...
  bin_centers_cdm = data_all['cdm'][snap_id]['bin_centers'][2:]
  distribution_cdm = data_all['cdm'][snap_id]['distribution'][2:]

  bin_centers_wdm = data_all['wdm'][snap_id]['bin_centers'][2:]
  distribution_wdm = data_all['wdm'][snap_id]['distribution'][2:]
  ...
  figure_name = output_dir + f'los_velocity_distribution_{snap_id}.png'
