...
input_dir = base_dir + 'transmitted_flux_temperature/'
output_dir = base_dir + 'flux_power_spectrum_temperature/'
...
for space in [ 'redshift', 'real']:
  ...
  for snap_id in snap_ids:
    ...
    # data_name = f'cdm_{space}_{snap_id:03}_temp_factor_{temp_factor}'
    data_name = f'wdm_{space}_{snap_id:03}_temp_factor_{temp_factor}'
