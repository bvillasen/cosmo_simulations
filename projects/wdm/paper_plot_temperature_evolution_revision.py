...
ax.legend( loc=2, frameon=False, fontsize=legend_font_size, labelcolor=text_color )
...
if black_background: figure_name = output_dir + f'T0_evolution_balck.png'
