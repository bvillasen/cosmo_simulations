...
# k_max = 10**-0.7
# alpha = 0.2
# ax1.fill_between( [k_min, k_max], [-1, -1 ], [1000, 1000], color='gray', alpha=alpha )
# ax2.fill_between( [k_min, k_max], [-1, -1 ], [1000, 1000], color='gray', alpha=alpha )
# 
...
# 
# 
# ax2.set_ylabel( r'$ P\,(k) / P_\mathrm{CDM}\,(k)$', fontsize=label_size, color= text_color )  
