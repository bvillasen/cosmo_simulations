...
for i in range(2):
  ...
  for i in range(6):
    ...
    pk_1 = data[sim_id][id]['power_spectrum']
    c = colors[i]
  ...
  if i==0:ax2.set_ylabel( r'$P_\mathrm{gas}(k) \, / \, P_\mathrm{gas,CDM}(k)$', fontsize=font_size, color=text_color  )
...
figure_name = output_dir + f'flux_ps_{n_points}_hydro.png'
if diff_log: figure_name = output_dir + f'flux_ps_{n_points}_hydro_log.png'
