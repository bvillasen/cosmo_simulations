...
file_name = input_dir + 'cdm_best_fit/tau_electron_best_fit.pkl'
tau_range_cdm = Load_Pickle_Directory( file_name )
...
tau_l = tau_range['low']
ax.plot( z_integral, tau, lw=3, c=color, label='This Work (WDM Best-Fit)', zorder=4 )
...
# 
tau = tau_range_cdm['HL']
 

ax.plot( z_integral, tau, ls='--', lw=lw, c='dodgerblue', label= r'This Work (CDM-Only Best-Fit)', zorder=5 )
