...
field_list = [ 'los_velocity', 'density'  ]
...
data_cdm = data_all['cdm']

vel_0 = data_cdm[0]['bin_centers']
dist_0 = data_cdm[0]['distribution']
max = np.where( dist_0 == dist_0.max() )[0]
peak_0 = vel_0[max] 

vel_1 = data_cdm[4]['bin_centers']
dist_1 = data_cdm[4]['distribution']
max = np.where( dist_1 == dist_1.max() )[0]
peak_1 = vel_1[max] 
