...
sigma_factor = 0.2
data_name = f'fit_results_P(k)+_Boera_covmatrix_sigma_factor_{sigma_factor}'
data_labels = [ '' ]
...
Plot_Corner( samples_all['param'], data_labels, corner_labels, output_dir, n_bins_1D=20, n_bins_2D=35, 
             ...
             limits=limits, param_values=param_values, black_background=False, figure_name=f'corner_wdm_sigma_factor_{sigma_factor}.png', 
