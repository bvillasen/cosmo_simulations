...
ax.set_ylabel( r'$P(T)$', fontsize=label_size, color= text_color )  
ax.set_xlabel( r'$T$  [K]', fontsize=label_size, color=text_color )
...
figure_name = output_dir + f'temperature_distribution.png'
