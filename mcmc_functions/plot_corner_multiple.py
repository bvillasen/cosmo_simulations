...
legend_loc = 3
Plot_Corner( samples_all['param'], data_labels, corner_labels, output_dir, n_bins_1D=40, n_bins_2D=40, lower_mask_factor=500, 
             multiple=True, show_label=True, HL_vals=params_HL, ticks=ticks, limits=limits, param_values=None, black_background=False,
             legend_loc=legend_loc, figure_name=figure_name)
