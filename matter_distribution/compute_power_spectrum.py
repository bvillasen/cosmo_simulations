...
data_name = 'python'
simulation_dir = data_dir + f'cosmo_sims/test_ics/'
input_dir = simulation_dir + f'snapshot_files_{data_name}/'
...
for snap_id in snap_ids:
  ...
  # break
# 
file_name = output_dir + f'power_spectrum_{data_name}_{data_type}.pkl'
