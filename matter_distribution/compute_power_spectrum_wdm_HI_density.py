...
HI_density = snap_data['HI_density']
nx, ny, nz = HI_density.shape
n_total = nx * ny * nz

print( f'Computing Power Spectrum  snap_id: {snap_id}  z:{z}' )
power_spectrum, k_vals, n_in_bin = get_power_spectrum( HI_density, Lbox, nx, ny, nz, dx, dy, dz,  n_kSamples=n_bins, fft_shift=False )
sim_data = { 'z':z, 'k_vals':k_vals, 'power_spectrum':power_spectrum, 'n_in_bin':n_in_bin }

file_name = output_dir + f'ps_HI_density_{snap_id}'
